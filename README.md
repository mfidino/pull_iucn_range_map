# Collecting species ranges from the IUCN red list data
...
<div align="center"><img width="100" height="auto" src="https://github.com/mfidino/pull_iucn_range_map/blob/main/opossum_range.png" alt="A range map for Virginia opossum." /></div>
